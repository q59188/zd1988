                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="mb-5 d-flex align-items-center justify-content-center">
                                ...
                                @else
                                    <span class="display-4 fw-600 lh-1 mb-0" style="font-size: 20px;">{{single_price($seller_package->amount)}}</span>
                                @endif
                            ...
                            <div class="text-center">
                                ...
                                @else
                                    @if (addon_is_activated('offline_payment'))
                                        <button class="btn btn-primary fw-600" onclick="select_payment_type({{ $seller_package->id}},'{{ translate('Pay with wallet')}}','{{single_price($seller_package->amount)}}')">{{ translate('Purchase Package')}}</button>
                                    @else
