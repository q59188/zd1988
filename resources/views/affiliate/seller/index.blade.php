                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{translate('Distribution Configuration')}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row gutters-10">
                                <div class="col-md-4 mx-auto">
                                    <div class="p-3 rounded c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                                        <span class="size-60px mx-auto d-flex align-items-center justify-content-center mb">
                                            <span class="la-3x text-white" style="color: #007bff !important;">
                                                    {{ get_setting('commission_ratio_level_1') }}%
                                            </span>
                                        </span>
                                        <div class="fs-18 text-primary">Level-1</div>
                                    </div>
                                </div>
                                <div class="col-md-4 mx-auto">
                                    <div class="p-3 rounded c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                                        <span class="size-60px mx-auto d-flex align-items-center justify-content-center mb">
                                            <span class="la-3x text-white" style="color: #007bff !important;">
                                                    {{ get_setting('commission_ratio_level_2') }}%
                                            </span>
                                        </span>
                                        <div class="fs-18 text-primary">Level-2</div>
                                    </div>
                                </div>
                                <div class="col-md-4 mx-auto">
                                    <div class="p-3 rounded c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                                        <span class="size-60px mx-auto d-flex align-items-center justify-content-center mb">
                                            <span class="la-3x text-white" style="color: #007bff !important;">
                                                    {{ get_setting('commission_ratio_level_3') }}%
                                            </span>
                                        </span>
                                        <div class="fs-18 text-primary">Level-3</div>
                                    </div>
                                </div>
                            </div>
                        </div>
