        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-sm-6">
                        <div class="card-title text-primary fs-16 fw-600">
                            <a href="{{ route('seller.money_withdraw_requests.index') }}">{{ translate('Send Withdraw Request') }}</a>
                        </div>
                        <p>&nbsp;</p>
                        <div class="card-title text-primary fs-16 fw-600">
                            <a href="{{ route('seller.money_withdraw_requests.index') }}">{{ translate('Offline Recharge Wallet') }}</a>
                        </div>
                        <p>&nbsp;</p>
                    </div>
