...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('smart_order.update', $row->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label"> {{translate('Order Time')}} <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-9">
                            <input type="text" class="aiz-date-range form-control" name="date_range" placeholder="{{ translate('Order Time') }}"
                                   data-format="YYYY-MM-DD" data-separator=" ~ " data-advanced-range="false" autocomplete="off" value="{{$row->date_range}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
