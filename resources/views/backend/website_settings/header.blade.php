		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="border-top pt-3">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Online Customer')}}</label>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="hidden" name="types[]" value="online_customer">
                                    <input type="text" class="form-control" placeholder="{{ translate('Online Customer') }}" name="online_customer" value="{{ get_setting('online_customer') }}">
                                </div>
                            </div>
                        </div>
                    </div>
