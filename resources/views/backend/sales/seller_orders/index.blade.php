...
<div class="card">
    <form class="" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <select class="form-control aiz-selectpicker mb-2 mb-md-0" data-live-search="true" id="seller_id" name="seller_id">
                        ...
                        @foreach (App\Models\User::where('user_type', '=', 'seller')->get() as $key => $seller)
                            <option value="{{ $seller->id }}" @if ($seller->id == $seller_id) selected @endif>
                                {{ $seller->name }} @if ($seller->shop) -【{{ $seller->shop->name }}】@endif
                            </option>
                        @endforeach
                    </select>
                </div>
