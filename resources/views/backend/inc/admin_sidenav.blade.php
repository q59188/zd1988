            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <!--    @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions)))
                          <li class="aiz-side-nav-item">
                            <a href="{{ route('wuliu_orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wuliu_orders'])}}">
                                <span class="aiz-side-nav-text">物流消息</span>   <!-- 卖家订单  -->
                            </a>
                          </li>
                        @endif
...
{{--                    <li class="aiz-side-nav-item">--}}
{{--                        <a href="{{route('smart_order.index')}}" class="aiz-side-nav-link">--}}
{{--                            <span class="aiz-side-nav-text">{{translate('Smart Order')}}</span>--}}
{{--                        </a>--}}
{{--                    </li>--}}

                    <li class="aiz-side-nav-item">
                        <a href="{{route('new_smart_order.index')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Smart Order')}}</span>
                        </a>
                    </li>
                @endif
