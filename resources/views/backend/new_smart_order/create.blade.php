...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('new_smart_order.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="time_range" id="time_range" placeholder="{{ translate('Order Time') }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Order Quantity')}}" id="quantity" name="quantity" value="1" class="form-control" required="">
                        </div>
                    </div>
                    <div class="form-group row">
