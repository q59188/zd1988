            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                        <a href="{{ route('shops.create') }}" class="btn btn-primary btn-xs">
                            {{ translate('Open store for free') }}
                        </a>
                    </li>
                    ...
                    @endif
                    @if (get_setting('online_customer'))
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="{{ get_setting('online_customer') }}" target="_blank" class="text-reset d-inline-block py-2">
                                <img src="{{ static_asset('assets/img/placeholder.jpg') }}" data-src="{{ static_asset('assets/img/customer.png') }}" class="lazyload" height="20">
                                <span class="opacity-60">{{ translate('Online Customer') }}</span>
                            </a>
                        </li>
                    @endif
                    @auth
