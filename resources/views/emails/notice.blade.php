                                        ...
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="text-align:center;">{{ translate('Time Range', 'en') }}</td>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:16px; line-height:16px; text-align:center; ">{{ $array['time_range'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align:center;">{{ translate('New Orders Count', 'en') }}</td>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:16px; line-height:16px; text-align:center; color:#2e57ae;">{{ $array['order_count'] }} </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
