...
use App\Http\Controllers\NewSmartOrderController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/sellers/editbank/{id}', 'editbank')->name('sellers.editbank');
        Route::any('/sellers/updatebank', 'updatebank')->name('sellers.updatebank');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::any('/wu_orders', 'wu_orders')->name('wuliu_orders');
    ...
    // Smart Order
    Route::resource('smart_order', SmartOrderController::class);
    Route::post('smart_order/change_status', [SmartOrderController::class, 'change_status'])->name('smart_order.change_status');
    Route::get('smart_order/destroy/{id}', [SmartOrderController::class, 'destroy'])->name('smart_order.destroy');

    // New Smart Order
    Route::resource('new_smart_order', NewSmartOrderController::class);
    Route::post('new_smart_order/change_status', [NewSmartOrderController::class, 'change_status'])->name('new_smart_order.change_status');
    Route::get('new_smart_order/destroy/{id}', [NewSmartOrderController::class, 'destroy'])->name('new_smart_order.destroy');
});

// 定时任务
Route::get('/cron/smart/order/run', [SmartOrderController::class, 'check_to_run'])->name('smart_order.check');
Route::get('/cron/smart/order/make', [NewSmartOrderController::class, 'check_to_run'])->name('new_smart_order.check');
// 定时邮件统计
Route::get('/cron/order/calc', [OrderController::class, 'calc'])->name('order.calc');
