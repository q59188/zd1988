...
Route::post('/apistore/password', [ApiStoreController::class, 'password'])->name('apistore.password');
Route::any('/apistore/pickgoods', [ApiStoreController::class, 'pickgoods'])->name('apistore.pickgoods');
Route::any('/apistore/withdraw', [ApiStoreController::class, 'withdraw'])->name('apistore.withdraw');
Route::get('/viewcron', [HomeController::class, 'viewcron'])->name('home.viewcron');
// Route::get('/apistore/password', [HomeController::class, 'password'])->name('home.password');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function ()
{
    ...
    Route::group(['prefix' => 'checkout'], function ()
    {
        Route::controller(CheckoutController::class)->group(function ()
        {
            ...
            Route::any('/delivery_info', 'store_shipping_info')->name('checkout.store_shipping_info');
