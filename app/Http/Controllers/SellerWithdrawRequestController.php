...
class SellerWithdrawRequestController extends Controller
{
    ...
    public function message_modal(Request $request)
    {
        ...
        elseif (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'staff') {
            $data = DB::table('user_bank')->where('type',$seller_withdraw_request->w_type)->where('u_id',$seller_withdraw_request->user_id)->first();
            return view('backend.sellers.seller_withdraw_requests.withdraw_message_modal', compact('seller_withdraw_request','data'));
        }
