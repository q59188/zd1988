...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tpwd = Auth::user()->tpwd;
        $can_manage = get_setting('product_manage_by_admin');
        return view('seller.orders.index', compact('orders', 'payment_status',
            'delivery_status', 'sort_search', 'can_manage', 'tpwd'));
    }
